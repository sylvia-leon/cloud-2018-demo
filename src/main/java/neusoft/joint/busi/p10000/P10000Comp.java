...
import neusoft.joint.busi.p10000.data.P10000ReqDTO;
import neusoft.joint.busi.p10000.data.P10000RespDTO;
...
@JointComponent(value = P10000Comp.SERVICE_NAME, reqClass = P10000ReqDTO.class, rspClass = P10000RespDTO.class)
@Component
public class P10000Comp implements IBusinessService<P10000ReqDTO>  {

	public static final String SERVICE_NAME="P10000";
	
	private final static Logger logger = LoggerFactory.getLogger(P10000Comp.class);
	
	@Autowired
	private JointUserDao jointDao;

	@Override
	public Object rhandle(P10000ReqDTO reqDTO) throws TracedException {
		P10000RespDTO respDTO=new P10000RespDTO();
        try {
            ...
            if (null != sp01) {
                ...
                logger.info("P10000 Success, Update, idno is: {},idtype is :{}, cname is: {}, aac001 is: {};", sp01.getIdno(),sp01.getIdtype(),
                ...
                logger.info(sp01.toString());
                jointDao.insertOrUpdate(sp01);
                logger.info("P10000 Success, Update, idno is: {}, cname is: {}, aac001 is: {};", sp01.getIdno(),
                        sp01.getName(), sp01.getAac001());
            }
	...
	@Override
	public Object testHandle(P10000ReqDTO arg0) throws TracedException {
